...
| 4 | Order of sessions and steps, with gates | Active: four named states; sessions 1–5 closed; next is session 6 (S2 readers · S1c · S3h) |
...
| C7 | S4a |
| C9 | S5b |
| C10 | S2 readers · S1c · S3h (session 6, with R16) |
| D1 D3 D4 | S3e |
| D2 D3 | S3d |
| D5 D6 | S3f |
| D7 | S3d (session 8) |
