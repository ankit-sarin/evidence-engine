...
_ADJUDICATION_TABLE = """
CREATE TABLE IF NOT EXISTS screening_adjudication (
...
CREATE INDEX IF NOT EXISTS idx_adjudication_paper
    ON screening_adjudication(paper_id);
CREATE INDEX IF NOT EXISTS idx_adjudication_ext_key
    ON screening_adjudication(external_key);
CREATE INDEX IF NOT EXISTS idx_adjudication_decision
    ON screening_adjudication(adjudication_decision);
"""
